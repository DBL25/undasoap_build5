...
export const PRODUCTS: Product[] = [
  {
    ...
    name: 'The Full Shift',
    tagline: '1x Reset + 1x Recharge + 1x Graveyard + Exclusive Mesh Pouch + Manifesto Card',
    category: 'bundles',
